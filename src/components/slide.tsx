...
const Slide: React.FC<propsTypes> = ({ img, title, mainTitle }) => {
  return (
    <div className="outline-none border-none relative">
      <div
        className="absoulute left-[30px] md:left-[70px] max:w-[250px] sm-max-w-[350] top-[50%]
   ...
   inline-block cursor-poiter hover:bg-blackish"> 
   shop Now
      ...
      <Image
        className=" w[50%] h-[150px] md:h-auto rounded-xl object-cover object-right
